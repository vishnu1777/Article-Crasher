...
const Demo = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (data?.summary) {
      ...
      // local storage only can contain string so we typecast object to strings
  ...
  const handleCopy = (copyURL) => {
    setCopied(copyURL);
    // inbuilt method to copy
    navigator.clipboard.writeText(copyURL);
    // we set a timeout for copy to put the copy image back to its place
    ...
    <section className="mt-16 w-full max-w-xl">
      ...
      <div className="flex flex-col w-full gap-2">
        ...
        >
          ...
          {/* peer is used to get styling for both parent and children element at same time */}
          <button
            type="submit"
